              ...
              >
                <div v-if="!successful">
                  ...
                  <div class="field padding-bottom--24">
                    ...
                    <Field type="password" name="password" id="myInput" />
                  ...
                  <div
                    class="field-checkbox padding-bottom--24 flex-flex align-center shwpsd"
                  >
                    <label for="checkbox">
                  ...
                  >
                    <label for="checkbox">
                      <Field type="checkbox" name="checkbox" /> Stay Signed in
                    </label>
                  </div>
                  <div class="field padding-bottom--24">
                    <input
...
input[type="submit"] {
  background-color: $base-color;
  box-shadow: rgba(0, 0, 0, 0) 0px 0px 0px 0px, rgba(0, 0, 0, 0) 0px 0px 0px 0px,
    rgba(0, 0, 0, 0.12) 0px 1px 1px 0px, rgb(84, 212, 142) 0px 0px 0px 1px,
    rgba(0, 0, 0, 0) 0px 0px 0px 0px, rgba(0, 0, 0, 0) 0px 0px 0px 0px,
